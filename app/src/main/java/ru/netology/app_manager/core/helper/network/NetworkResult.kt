package ru.netology.app_manager.core.helper.network

import ru.netology.app_manager.core.helper.network.NetworkResult.Companion.EXCEPTION_OCCURRED_CODE
import ru.netology.app_manager.core.helper.network.exceptions.EmptyBodyException
...
sealed class NetworkResult<T>(
    ...
    object Loading : NetworkResult<Nothing>(status = NetworkStatus.LOADING)
